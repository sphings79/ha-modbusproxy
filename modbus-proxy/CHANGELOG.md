...
| Version | Change                                                      |
| ------- | ----------------------------------------------------------- |
| 1.1.1-exception-frame.1 | build from a modbus-proxy fork that frames exception replies by the protocol rather than by the MBAP length field, for devices that declare it wrong (Marstek Venus D). See Akulatraxas/ha-modbusproxy#43 and tiagocoutinho/modbus-proxy#62 |
